...
public class User implements Serializable {
	...
	public User(String username, String password, LinkedList<String> tags, int userdId) {
	...
	public ArrayList<Post> PostsWhitoutNew() {
		return posts;
	}
	
	public ArrayList<Post> postWithoutNew(){
		return posts;
	}
	...
	public boolean addHistory(double price) {
		return history.add(price);
	}
	...
	public void addWallet(double sum) {
		wallet = wallet + sum;
	}
