...
public class ClientMain extends RemoteObject implements NotifyClientInterface{
	...
	private ArrayList<String> followers; // followersCallBack
	private ArrayList<String> posts;	 // postsCallBack
	private ArrayList<User> usersList;	 // usersListCallBack
	private ArrayList<String> following; // followingCallBack
	...
	public void start() {
		...
		try {
			...
			FileInputStream input = new FileInputStream("/Users/davidebulotta/eclipse-workspace/ProgettoReti/src/socialMedia/ServerConfig.properties");
			prop.load(input);
